from instaloader_api import InstagramLoader

if __name__ == "__main__":
    loader = InstagramLoader()

    # Log in with username and password
    if loader.login("your_username", "your_password"):
        # Download a profile's posts and stories
        loader.download_profile("target_profile", download_posts=True, download_stories=True)

        # Download posts from a hashtag
        loader.download_hashtag("travel", max_count=10)
